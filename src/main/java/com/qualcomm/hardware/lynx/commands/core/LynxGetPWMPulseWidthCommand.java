...
public class LynxGetPWMPulseWidthCommand extends LynxDekaInterfaceCommand<LynxGetPWMPulseWidthResponse> {
    ...
    public LynxGetPWMPulseWidthCommand(LynxModuleIntf lynxModuleIntf) {
        super(lynxModuleIntf, new LynxGetPWMPulseWidthResponse(lynxModuleIntf));
    }

    public LynxGetPWMPulseWidthCommand(LynxModuleIntf lynxModuleIntf, int i) {
        this(lynxModuleIntf);
