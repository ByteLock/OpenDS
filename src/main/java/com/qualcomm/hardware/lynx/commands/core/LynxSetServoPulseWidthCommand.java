...
public class LynxSetServoPulseWidthCommand extends LynxDekaInterfaceCommand<LynxAck> {
    public static final int apiPulseWidthFirst = 1;
    public static final int apiPulseWidthLast = 65535;
    public static final int cbPayload = 3;
    private byte channel;
    private short pulseWidth;

    public LynxSetServoPulseWidthCommand(LynxModuleIntf lynxModuleIntf) {
        super(lynxModuleIntf);
    }

    public LynxSetServoPulseWidthCommand(LynxModuleIntf lynxModuleIntf, int i, int i2) {
        this(lynxModuleIntf);
