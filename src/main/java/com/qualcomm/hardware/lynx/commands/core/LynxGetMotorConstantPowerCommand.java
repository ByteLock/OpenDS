...
public class LynxGetMotorConstantPowerCommand extends LynxDekaInterfaceCommand<LynxGetMotorConstantPowerResponse> {
    ...
    public LynxGetMotorConstantPowerCommand(LynxModuleIntf lynxModuleIntf) {
        super(lynxModuleIntf, new LynxGetMotorConstantPowerResponse(lynxModuleIntf));
    }

    public LynxGetMotorConstantPowerCommand(LynxModuleIntf lynxModuleIntf, int i) {
        this(lynxModuleIntf);
