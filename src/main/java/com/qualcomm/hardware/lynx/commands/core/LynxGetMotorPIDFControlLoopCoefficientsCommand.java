...
public class LynxGetMotorPIDFControlLoopCoefficientsCommand extends LynxDekaInterfaceCommand<LynxGetMotorPIDFControlLoopCoefficientsResponse> {
    ...
    public LynxGetMotorPIDFControlLoopCoefficientsCommand(LynxModuleIntf lynxModuleIntf) {
        this(lynxModuleIntf, 0, DcMotor.RunMode.RUN_USING_ENCODER);
    }

    public LynxGetMotorPIDFControlLoopCoefficientsCommand(LynxModuleIntf lynxModuleIntf, int i, DcMotor.RunMode runMode) {
        super(lynxModuleIntf, new LynxGetMotorPIDFControlLoopCoefficientsResponse(lynxModuleIntf));
        LynxConstants.validateMotorZ(i);
        this.motor = (byte) i;
        int i2 = C06991.$SwitchMap$com$qualcomm$robotcore$hardware$DcMotor$RunMode[runMode.ordinal()];
        if (i2 == 1) {
            this.mode = 1;
        } else if (i2 == 2) {
            this.mode = 2;
    ...
    /* renamed from: com.qualcomm.hardware.lynx.commands.core.LynxGetMotorPIDFControlLoopCoefficientsCommand$1 */
    static /* synthetic */ class C06991 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.qualcomm.hardware.lynx.commands.core.LynxGetMotorPIDFControlLoopCoefficientsCommand.C06991.<clinit>():void");
        }
    }
