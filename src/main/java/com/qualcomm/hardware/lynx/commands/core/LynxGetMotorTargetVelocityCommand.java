...
public class LynxGetMotorTargetVelocityCommand extends LynxDekaInterfaceCommand<LynxGetMotorTargetVelocityResponse> {
    ...
    public LynxGetMotorTargetVelocityCommand(LynxModuleIntf lynxModuleIntf) {
        super(lynxModuleIntf, new LynxGetMotorTargetVelocityResponse(lynxModuleIntf));
    }

    public LynxGetMotorTargetVelocityCommand(LynxModuleIntf lynxModuleIntf, int i) {
        this(lynxModuleIntf);
