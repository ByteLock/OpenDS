...
public interface WebSocketManager {
     ...
     */
    void registerNamespaceHandler(@NotNull WebSocketNamespaceHandler handler);
     ...
     * @throws IllegalArgumentException if the namespace is invalid, reserved, or already registered with a handler
     */
    void registerNamespaceAsBroadcastOnly(@NotNull String namespace);
     ...
     */
    int broadcastToNamespace(@NotNull String namespace, @NotNull FtcWebSocketMessage message);
}
